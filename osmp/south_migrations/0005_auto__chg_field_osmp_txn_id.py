...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OSMP.txn_id'
        db.alter_column('osmp', 'txn_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'OSMP.txn_id'
        db.alter_column('osmp', 'txn_id', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True))
    ...
    models = {
        u'osmp.osmp': {
            ...
            'txn_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'})
        }
    }
